...
* Translations
    * README.md
    * [docs](https://github.com/aluzme/docs/issues/1)
* Bug-hunting
* Finding security problems
* Themes and Plugins

See [manual](https://github.com/aluzme/go-admin/projects/3) for more information.
...
For now, you need to add your fork as a remote on the original **\$GOPATH**/src/github.com/aluzme/go-admin clone, so:

```bash

$ go get github.com/aluzme/go-admin
$ cd $GOPATH/src/github.com/aluzme/go-admin # GOPATH is $HOME/go by default.
...
Notice: `go get` return `package github.com/aluzme/go-admin: no Go files in /go/src/github.com/aluzme/go-admin` is normal.
...
* [Tasks](https://github.com/aluzme/go-admin/projects)
