...
上手例子：[https://github.com/aluzme/example](https://github.com/aluzme/example/blob/master/README_CN.md)

GoAdmin+vue 例子： [https://github.com/aluzme/goadmin-vue-example](https://github.com/aluzme/goadmin-vue-example)
...
## 翻译
我们需要您的帮忙： [https://github.com/aluzme/docs/issues/1](https://github.com/aluzme/docs/issues/1)

## 谁在使用GoAdmin

[评论这个issue告诉我们](https://github.com/aluzme/go-admin/issues/71).
...
更多框架的例子: [https://github.com/aluzme/go-admin/tree/master/examples](https://github.com/aluzme/go-admin/tree/master/examples)
...
[这里一个超级简单上手的例子](https://github.com/aluzme/example)
...
这里是[开发计划](https://github.com/aluzme/go-admin/projects)
