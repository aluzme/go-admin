...
import (
	...
	errors2 "github.com/aluzme/go-admin/modules/errors"
	"github.com/aluzme/go-admin/modules/language"
	"github.com/aluzme/go-admin/modules/logger"
	"github.com/aluzme/go-admin/modules/menu"
	...
	"github.com/aluzme/go-admin/template/login"
...
type Component interface {
	...
	//
	// See:
	// https://github.com/aluzme/go-admin/blob/master/template/login/theme1.tmpl#L32
	// https://github.com/aluzme/go-admin/blob/master/template/login/list.go
	GetAssetList() []string
